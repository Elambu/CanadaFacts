...
import com.task.facts.adapter.FactsShimmerAdapter;


public class FactsShimmerRecycler extends RecyclerView {

    public enum LayoutMangerType {
        LINEAR_VERTICAL, LINEAR_HORIZONTAL, GRID
    }

    private FactsShimmerAdapter mShimmerAdapter;
    ...
    public FactsShimmerRecycler(Context context) {
        super(context);
        init(null);
    }

    public FactsShimmerRecycler(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public FactsShimmerRecycler(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        mShimmerAdapter = new FactsShimmerAdapter();
        ...
        try {
            if (a.hasValue(R.styleable.ShimmerRecyclerView_demo_layout)) {
                setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_demo_layout, R.layout.row_shimmerview));
            }
